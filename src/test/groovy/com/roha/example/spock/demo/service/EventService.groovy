...
class EventServiceTest extends Specification {
    ...
    def "should create event"(){
        ...
        Event event = eventService.createEvent("toutpartout", eventDate, true, "Whispering sons en meer")
        ...
        event = eventService.createEvent("!!! (Chk Chk Chk)", eventDate.plusDays(1), false, "!!! (Chk Chk Chk)")
        event.price= 20.5f
